...
function create() {
  ...
  Calque_de_background = carteDuNiveau.createLayer(
    "Calque de background",
    tileset
  );
  // chargement du calque calque_background_2
  calque_de_background_2 = carteDuNiveau.createLayer(
    "clalque de background 2",
    tileset
  );
  // chargement du calque calque_plateformes
  calque_de_platetorm = carteDuNiveau.createLayer(
    "calque de platetorm",
    tileset
  );
  // définition des tuiles de plateformes qui sont solides
  // utilisation de la propriété estSolide
  calque_de_platetorm.setCollisionByProperty({ estSolide: true })
  ...
  this.physics.add.collider(player, calque_de_platetorm);
